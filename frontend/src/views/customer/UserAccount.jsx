              ...
              <div className='box button-container center pt-1 d-flex justify-content-between'>
                ...
                {/* <div className='box d-flex flex-column'>
                  <div className='box d-flex my-2 justify-content-end'>
                    {account.isActive ? (
                      <>
                        <Button to="/customer/" variant="outline-danger" className="btn btn-custom d-flex align-items-center" onClick={handleCloseAccount}>
                      ...
                      <>
                        <Button to="/customer/" variant="outline-success" className="btn btn-custom d-flex align-items-center" onClick={handleActiveAccount}>
